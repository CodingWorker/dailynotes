<?php 
//加密 
$key = 'uageniustofindit'; 
$content = '案:<?php/***byte数组与字符串转化类*/classBy';
...
$mw = base64_decode("1kS7tMh8RTPQkqSYKIYQCqBjbhX8QtWkjkYTp6AhU9yZpITIT0gezeVVwlYlHDMki/VvVFhhOjGtvWJBb1h+eA==");
